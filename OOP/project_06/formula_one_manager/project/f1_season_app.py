from project_06.formula_one_manager.project.formula_teams.mercedes_team import MercedesTeam
from project_06.formula_one_manager.project.formula_teams.red_bull_team import RedBullTeam
...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int):
        ...
        result = self.get_race_result(race_name, red_bull_pos, mercedes_pos)
        return result
