# from projects_02.spoopify.project.album import Album
# from projects_02.spoopify.project.song import Song
from projects_03.players_and_monsters.project import Album
...
class Band:
    ...
    def details(self):
        ...
        [output.append(f"== {a.details()}") for a in self.albums]
        return "\n".join(output)
